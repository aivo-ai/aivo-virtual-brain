...
export type DigestSubscriptionUpdateFrequency =
  (typeof DigestSubscriptionUpdateFrequency)[keyof typeof DigestSubscriptionUpdateFrequency];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DigestSubscriptionUpdateFrequency = {
  daily: "daily",
  weekly: "weekly",
} as const;
