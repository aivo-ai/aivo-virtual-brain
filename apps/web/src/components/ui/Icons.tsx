...
export function ClipboardList({ className }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
      ...
      <path
        fillRule="evenodd"
        d="M4 5a2 2 0 012-2v1a1 1 0 001 1h6a1 1 0 001-1V3a2 2 0 012 2v6h-3a1 1 0 100 2h3v3a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z"
        clipRule="evenodd"
      />
    </svg>
  )
...
export function MicOff({ className }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
      <path d="M2.293 2.293a1 1 0 011.414 0L7 5.586V8a3 3 0 106 0V6.414l3.707 3.707a1 1 0 001.414-1.414l-2-2-.707-.707-1-1-4-4-4-4a1 1 0 00-1.414 0z" />
    </svg>
  )
}
